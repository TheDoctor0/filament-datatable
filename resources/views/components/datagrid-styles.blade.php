<style>
    ...
    .rg-alert td{background:rgba(185,28,28,.09);}
    :where(.dark) .rg-alert td{background:rgba(248,113,113,.10);}
    .rg-alert:hover td{background:rgba(185,28,28,.15);}
    :where(.dark) .rg-alert:hover td{background:rgba(248,113,113,.16);}
